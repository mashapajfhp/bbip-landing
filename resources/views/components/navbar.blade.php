<header class="sticky top-0 z-50 py-3 bg-white/90 backdrop-blur-md border-b border-blue-100 shadow-sm">
    <div class="container" x-data="{ open: false }">
        <nav class="flex items-center justify-between gap-5 bg-white/97 border border-line rounded-3xl p-2.5 shadow-md">
            ...
            <button
                ...
                class="md:hidden p-2 rounded-lg hover:bg-gray-100 transition-colors ml-auto"
            >
