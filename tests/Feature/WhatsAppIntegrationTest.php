...
class WhatsAppIntegrationTest extends TestCase
{
    ...
    public function test_landing_page_uses_approved_feedback_copy(): void
    {
        ...
        $response->assertSee('FROM INSIGHT TO GROWTH');
        $response->assertSee('START WITH INSIGHT');
        $response->assertSee('Start with insight.');
        $response->assertSee('Build a better you.');
        ...
        $response->assertSee('Visible Progress');
